...
3. Obsidian の設定ページに移動し、[コミュニティ プラグイン] タブをクリックします。
4. 「コミュニティプラグイン」タブの右側にある「フォルダー」ボタンをクリックします。 ファイルビューが表示されます。 「obsidian-quail」フォルダーをファイル ビューにコピーします。
5. Obsidianを再起動する
6. 「コミュニティ プラグイン」タブに移動し、Quail プラグインを見つけて、「有効にする」 ボタンをクリックします。
